...
This project is planned in four main phases: <b>Data Acquisition, Data Preprocessing, Data Modeling, and Developing a Mobil App</b> 
     

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/DataAcqusation.jpg" title="Example image" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
